...
const { getOther, getRequest, getListFriends, getFriend, addFriend, ignoreFriend, acceptFriend, unFriend } = require('../controllers/friends-controller')

router.get('/search-friends', getOther)
router.get('/request-friends', getRequest)
router.get('/list-friends', getListFriends)
router.post('/get-friend', getFriend)
